...
class TermsTableViewCell: UITableViewCell {
    ...
    func setupUI() {
        ...
        terms2Label.text = "本サービスは、会員同士が趣味嗜好の合うコミュニティーを探し、コミュニティーメンバーと相互にチャットを行い、コミュニケーションを行うサービスです。"
//        "本サービスは、会員同士が趣味嗜好の合う人を探し、相互にメッセージをやり取りするなどのコミュニケーションを通じて、好みのパートナーと知り合うことができる完全無料のマッチングサービスです。"
